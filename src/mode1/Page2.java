...
public class Page2 extends Fragment {
	...
	public void onStop() {
		// TODO Auto-generated method stub
		super.onStop();
		Log.d("EPP", "Page2-->onStop()");
	}
	
	@Override
	public void setUserVisibleHint(boolean isVisibleToUser) {
	    super.setUserVisibleHint(isVisibleToUser);
	    Log.d("EPP", "Page2-->setUserVisibleHint:"+isVisibleToUser);
	    if (isVisibleToUser) {
	        //相当于Fragment的onResume
			IsMon = false;
			KeyCtrBt.setText(getActivity().getResources().getString(R.string.Start));
			PLStr = "";
			ReportTv.setText("");
		...
		KeyCtrBt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(IsMon){
					...
					//KeyCtrBt.setText(getActivity().getResources().getString(R.string.Stop));
					IsMon = true;
					PLStr = new String();
					KeyValueEd.setText("");
					KeyAscEd.setText("");
