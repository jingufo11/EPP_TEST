...
public class Page4 extends Fragment {
	...
	public void onStop() {
		// TODO Auto-generated method stub
		super.onStop();
		Log.d("EPP", "Page4-->onStop()");
	}
	
	@Override
	public void setUserVisibleHint(boolean isVisibleToUser) {
	    super.setUserVisibleHint(isVisibleToUser);
	    Log.d("EPP", "Page4-->setUserVisibleHint:"+isVisibleToUser);
	    if (isVisibleToUser) {
	...
	public void StartPin(){
		...
		ret = KMY3501.PINStart(Integer.parseInt(CurPinLen, 16),0,30);
		if(ret == 0){
	...
	private void ProPinInput(String Key){
		logbook.WriteLog("ProPinInput", "Key="+Key);
		if(Key.equals("2A"))
			PLStr += "*";
